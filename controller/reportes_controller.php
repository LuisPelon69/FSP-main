<?php 
    require_once('modelo/estudiante_model.php'); //Requiere obligatoriamente al archivo estudiante_model de la carpeta modelo 

    class estudiante_controller{ //En caso que el estudiante active el controller 

        private $model_e; //Variable
        private $model_p; //Variable
        ...
        function index(){
            //En caso de que abran Index va a ejecutar todo lo que este en get
